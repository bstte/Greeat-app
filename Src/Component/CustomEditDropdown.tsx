...
const CustomEditDropdown: React.FC<DropdownProps> = ({ data, placeholder, title, selectedValue, onSelect,required }) => {
                ...
                <View style={styles.dropdowncontainer}>
                    <TouchableOpacity onPress={toggleModal} style={styles.dropdownContent}>
                        <Text style={styles.dropdownText}>
                            {selectedValue ? selectedValue : selectedItem ? selectedItem.label : placeholder}
                        </Text>
                    ...
                    <View style={[styles.modalContainer, styles.modalContainerCentered]}>
                        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                            <View style={[styles.modal, { width: responsiveWidth(100), height: responsiveHeight(60) }]}>
                                <View style={{ width: '15%', height: responsiveHeight(0.4), justifyContent: 'center', alignSelf: 'center', backgroundColor: '#ccc', marginTop: 10, marginBottom: 20 }} />
                                ...
                                <SectionList
                                    ...
                                    renderItem={({ item }) => (
                                        <TouchableOpacity
                                            ...
                                            style={[
                                                styles.modalItem,
                                                (selectedItem && selectedItem.value) || (selectedValue && selectedValue === item.value) && styles.selectedItem,
                                            ]}
                                        >
